...
public class RSyntaxTextAreaEditorKit extends RTextAreaEditorKit {
	...
	private static final String MSGs	= "i18n.org.fife.ui.rsyntaxtextarea.RSyntaxTextArea";
	private static final ResourceBundle msg = ResourceBundle.getBundle(MSGs);
