...
/**
 * Clase encargada de representar a la "funcion"
 *
 * <p>
 ...
 */
public class TareaCompuestaFuncUsuario extends TareaCompuesta {
     ...
     *
     * @param nodo Nodo que invoca al proceso
     * @param contextoPadre pila con la que se invoca al proceso
     */
    public TareaCompuestaFuncUsuario(SimpleNode nodo, Hashtable<String, Object> contextoPadre) {
        super(obtenerNodoProceso(nodo), crearPilaProceso(contextoPadre));
        setNombre(((ASTFuncionUsuario) nodo).getNombre());
     ...
     * formales.
     *
     * @param parametrosFormales parametros de la definicion del proceso
     * @param nombreParametrosReales nombre de los parametros reales
     * @param contexto pila del proceso
     * @param contextoPadre pila del que llama al proceso
     * @param valores valores de los parametros reales
     */
    ...
    private List<String> obtenerNombreParametrosReales(SimpleNode nodo) {
        return ((ASTFuncionUsuario) nodo).getNombresParametrosReales();
    }
     ...
     *
     * @param children Nodos que representan los parametros a interpretar
     */
    ...
    private static SimpleNode obtenerNodoProceso(SimpleNode nodo) {
        ...
        return DefinicionProcedimientos.get(((ASTFuncionUsuario) nodo).getNombre());
    }

    /**
     * Crea la pila para el proceso.
     *
     * @param contexto pila con la que se invoca al proceso
