...
public class LinePainter implements Highlighter.HighlightPainter, CaretListener, MouseListener,
		MouseMotionListener {
	...
	public void resetHighlight(int offset) {
		component.getHighlighter().removeAllHighlights();
		try {
			component.getHighlighter().addHighlight(offset, offset + 1, this);
			component.repaint();
