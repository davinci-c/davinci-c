 ...
 * @author german
 */
public class ConfiguracionDePapelesAleatoria extends ConfiguracionDePapeles{
     ...
     * Auditor
     */
    private static final Logger auditor = Logger.getLogger(ConfiguracionDePapelesAleatoria.class.getName());
     ...
     * 
     */
    public ConfiguracionDePapelesAleatoria(){
        super();
     ...
     * @param l 
     */
    public ConfiguracionDePapelesAleatoria(Integer a, Integer c, Integer n, Integer h, Integer l){
        super(a, c, n);
